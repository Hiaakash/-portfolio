...
import AkashShuklaCV from '../assets/AkashShuklaCV.pdf'
...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!form.name || !form.email || !form.message) {
      alert('Opps, Please enter all the details. Thank you')
      setLoading(false)
      return
    }
    ...
    emailjs.send(
      ...
      'template_nifbrpj',
      {
        ...
        to_email: 'akash159shukla@gmail.com',
      ...
      >
        ...
        <form action="" ref={formRef} onSubmit={handleSubmit} className="mt-12 flex flex-col gap-8">
          ...
          <button className='bg-tertiary py-3 px-8 outline-none w-fit text-white font-bold shadow-md shadow-primary rounded-xl'>
            <a href={AkashShuklaCV} download='AkashShuklaCV'>Get My Resume</a>
          </button>
        </form>
      </motion.div>
