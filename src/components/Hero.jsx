  ...
  return (
    <section className='relative w-full h-screen mx-auto'>
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] mx-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>Hi, I'm <span className='text-[#915eff]'>Aakash</span></h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            A full stack engineer, love <br className='sm:block hidden' />
            to develop top notch user interfaces and web applications.
          </p>
        </div>
      </div>
      <ComputersCanvas />
